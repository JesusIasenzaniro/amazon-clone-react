...
const CheckoutForm = () => {
    ...
    return (
        <div>
            {succeeded ? (
                <div className='container__success__payment'>
                    <h4>Thank you</h4>
                    <h4>Your payment was succesful!</h4>
                    <h4>Redirecting to home page shortly</h4>
                </div>
            ) : (
                <div className='container__error__payment'>
                    <h4>Hello, {myUser && myUser.name}</h4>
                    <p>
                        Your total is <span>{formatPrice(shipping_fee + total_amount)}</span>
                    </p>
                    <p>
            ...
            <form id='payment-form' onSubmit={handleSubmit}>
                ...
                <p className={succeeded ? 'result-message' : 'result-message hidden'}>
                    Payment succedded
                    {/* <a href={`https://dashboard.stripe.com/text/payments`}> Stripe dashboard.</a>
